...
export function ExamCertificateManager({
  certificates = [],
  onChange,
  disabled = false,
}: ExamCertificateManagerProps) {
            ...
            <div>
              <DatePicker
                ...
                onChange={(date) =>
                  setFormData({
                    ...formData,
                    date_taken: dateObjectToDateString(date),
                  })
                }
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    place_of_examination: e.target.value,
                  })
                }
              />
            </div>
            ...
            <div>
              <DatePicker
                ...
                onChange={(date) =>
                  setFormData({
                    ...formData,
                    validity_date: dateObjectToDateString(date),
                  })
                }
              />
            </div>
      ...
      {certificates.length === 0 && !isAdding && (
        <div className="text-center py-12">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Click "Add Eligibility" to get started
          </p>
        </div>
      )}
    </div>
